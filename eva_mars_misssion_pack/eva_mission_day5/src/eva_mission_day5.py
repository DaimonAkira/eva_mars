...
# EVA MARS MISSION ROBOT - MISSON DAY 5 
# READY FOR MISSIONS
...
def sondaj_control():
    ...
    pub_sondaj = rospy.Publisher('eva/sondaj_joint_position_controller/command', Float64, queue_size=10)
    pub_sondaj2 = rospy.Publisher('eva/sondaj2_joint_position_controller/command', Float64, queue_size=10)
    pub_sondaj3 = rospy.Publisher('eva/sondaj3_joint_position_controller/command', Float64, queue_size=10)
    pub_camport = rospy.Publisher('eva/camera_port_joint_position_controller/command', Float64, queue_size=10)
